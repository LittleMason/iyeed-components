  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/tm/dictionaryDt/queryDictionaryCbList',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/tm/dictionaryDt/initUpdate/',
      };
    },
    methods: {
      /**
