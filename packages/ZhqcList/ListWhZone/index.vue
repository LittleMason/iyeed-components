  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/wh/whZone/queryWhZoneCbList',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/wh/whZone/initUpdate/',
      };
    },
    methods: {
      /**
