  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/partner/owner/queryOwnerCbList',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/partner/owner/initUpdate/',
      };
    },
    methods: {
      /**
