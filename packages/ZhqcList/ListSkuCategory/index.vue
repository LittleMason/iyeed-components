  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/sku/skuCategory/queryCbList',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/sku/skuCategory/queryCb/',
      };
    },
    methods: {
      /**
