  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/gsp/pro/maintainUser/queryMaintainUserCbList',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/gsp/pro/maintainUser/initUpdate/',
      };
    },
    methods: {
      /**
