  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/partner/store/queryStoreCbList',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/partner/store/initUpdate/',
      };
    },
    methods: {
      /**
