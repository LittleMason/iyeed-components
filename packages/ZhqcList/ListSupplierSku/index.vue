  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/partner/supplier/querySupplierCbListBySkuId',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/partner/supplier/initUpdate/',
      };
    },
    methods: {
      /**
       ...
       */
      listApi(queryText) {
        let data = {queryText: queryText,skuId:this.skuId,skuCode:this.skuCode, page: this.$globalPage, limit: this.$globalLimit};
        return service({
          url: this.listUrl,
          method: 'post',
