  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/wh/whArea/queryWhAreaCbList',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/wh/whArea/initUpdate/',
      };
    },
    methods: {
      /**
