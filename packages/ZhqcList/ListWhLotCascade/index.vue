  ...
  export default {
    ...
    data() {
      return {
        ...
        list: [],
        loading: false,
        listUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/wh/whLot/queryWhLotCbListByZoneId',
        itemUrl: process.env.VUE_APP_WMS_RESOURCE_MODEL+'/base/wh/whLot/initUpdate/',
      };
    },
    methods: {
      /**
